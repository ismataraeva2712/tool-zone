...
const Business = () => {
    return (
        ...
        >
            <h1 className='text-2xl font-bold text-secondary my-12'>Business Summery</h1>
            <AnimationOnScroll animateIn="animate__swing"  initiallyVisible={true}>
         <div 
    ...
    <div className="stat-value text-primary">70.6K</div>
  ...
  <div className="stat">
    ...
    <div className="stat-value text-secondary">5.6M</div>
  ...
  <div className="stat">
    ...
    <div className="stat-value">4,2000</div>
  ...
  <div className="stat">
    ...
    <div className="stat-desc">↘︎ 100 (24%)</div>
  </div>
  <div className="stat">
    <div className="stat-figure text-secondary">
    ...
    <div className="stat-title">Members Active</div>
    <div className="stat-desc text-secondary">6%  remaining</div>
  </div>
